$(document).ready(function(){
	...
	$(document).on("click",".header-sort",function(){
		...
		sortUserProject([{name:"dataField",value:dataField},{name:"valueSortField",value:valueSort}]);
	...
	$(window).scroll(function(){
		...
		if(srollTopPosition ==  heightDocument && $(".remain-user-project-data").length > 0){
			loadMoreUserProject();
		}
	});
});